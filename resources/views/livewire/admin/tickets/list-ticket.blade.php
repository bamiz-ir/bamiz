                ...
                <table class="table table-hover">
                    ...
                    @foreach ($tickets as $item)
                        <tr>
                            ...
                            <td>
                                <div class="buttons ">
                                    <a href="{{ route('tickets.edit' , $item->id) }}" class="btn btn-primary btn-action mr-1"
    ...
    <script type="text/javascript">
        ...
        @this.on('triggerDelete', orderId => {
            Swal.fire({
                title: "هشدار ! ",
                icon: 'warning',
                text: "آیا می خواهید این تیکت بسته شود ؟ 🤔",
                type: "warning",
