    ...
    <div class="col-lg-12">
        <div class="card-box">
            <div class="card-block">
                ...
                <table class="table table-hover">
                    ...
                    @foreach ($galleries as $item)
                        <tr>
                            ...
                            <td>{{ $item->type == 'teaser' ?  'تیزر' :  'عکس' }}</td>
                            <td><img width="60" src="{{ $item->captions[0] }}" alt="عکس گالری"></td>
                ...
                {{ $galleries->links('livewire.admin.pagination') }}
    ...
    <script type="text/javascript">
        ...
        @this.on('triggerDelete', orderId => {
            Swal.fire({
                title: "هشدار ! ",
                icon: 'warning',
                text: "آیا می خواهید این گالری حذف شود ؟ 🤔",
                type: "warning",
