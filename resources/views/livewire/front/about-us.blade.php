<div>
    ...
    <div class="bg_color_1">
        <div class="container margin_80_55">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-5">
                    <p>{{ $about_us_text->value }}</p>
                    <p><em>{{ $default_site_admin->value }}</em></p>
                </div>
            </div>
            <!--/row-->
        </div>
    ...
    <div class="container margin_80_55">
        <div class="main_title_2">
            <span><em></em></span>
            <h2>دوستان ما (کافه و رستوران ها)</h2>
            <p>کافه و رستوران هایی که افتخار همکاری باهاشون رو داریم</p>
        </div>
