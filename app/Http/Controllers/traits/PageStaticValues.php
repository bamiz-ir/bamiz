...
trait PageStaticValues
{
    ...
    private function CreateOrShowSettingData($key , $value)
    {
        return Setting::query()->firstOrCreate(['key' => $key] , [
           'key' => $key,
           'value' => $value
        ]);
    }

    private function HeaderAndFooterStaticData()
    {
...
//            ]);
//
//        $this->settings['about_us_text'] = Setting::query()->firstOrCreate(['key' => 'about_us_text'] ,
//            [
//                'value' => 'This about us Page of bamiz restaurant handling website...'
//            ]);
//
//        $this->settings['about_us_title'] = Setting::query()->firstOrCreate(['key' => 'about_us_title'] ,
//            [
//                'value' => 'Bamiz is one of the best'
//            ]);
//    }
}
