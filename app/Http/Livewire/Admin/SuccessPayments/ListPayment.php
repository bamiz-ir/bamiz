...
namespace App\Http\Livewire\Admin\SuccessPayments;
...
class ListPayment extends Component
{
    ...
    public function UnSuccess(Payment $payment)
    {
        $payment->update(['status' => 0]);
    }

    private function selectSuccessPayments(): void
    {
    ...
    public function render()
    {
        ...
        return view('livewire.admin.success-payments.list-payment' , ['payments' => $this->payments]);
    }
}
